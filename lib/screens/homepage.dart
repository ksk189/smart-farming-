...
import 'package:doctorplant/screens/scan_crop.dart/scan.dart';
...
class _HomepageState extends State<Homepage> {
  final List<Map<String, String>> _persons = [
    {
      'name': 'Naveen Kalisetti (Team Leader)',
      'designation': 'Full Stack Developer',
      'imageUrl': 'assets/profile/madhav.jpg',
    },
    {
      'name': 'Lakshmi thirupathamma ',
            ...
            children: [
              ...
              const Padding(
                ...
                child: FittedBox(
                  fit: BoxFit.fitWidth,
                  child: Text(
                    'Heal Your Crop With Raithu Nestham AI',
